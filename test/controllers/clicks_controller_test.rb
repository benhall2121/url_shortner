...
class ClicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create click" do
    assert_difference('Click.count') do
      post clicks_url, params: { click: { ip_address: @click.ip_address, url_id: @click.url_id } }
    end
  ...
  test "should update click" do
    patch click_url(@click), params: { click: { ip_address: @click.ip_address, url_id: @click.url_id } }
